...
public class Reporter : MonoBehaviour
{
	...
	//new scene is loaded
	void OnLevelWasLoaded_0(Scene scene, Scene scene1)
	{
	...
	void DrawLogs()
	{
		...
		for (int i = startIndex; (startIndex + index) < endIndex; i++) {
			...
			Rect cRect0 = countRect;
			cRect0.x = Screen.width - w;
			cRect0.y = size.y * i;
			countRect = cRect0;
		...
		Rect butRect = buttomRect;
		butRect.x = 0f;
		butRect.y = Screen.height - size.y;
		buttomRect = butRect;
		//buttomRect.x = 0f;
	...
	public void OnGUIDraw()
	{
		...
		Rect detRect0 = detailRect;
		detRect0.x = 0f;
		detRect0.y = Screen.height - size.y * 3;
		detailRect = detRect0;
